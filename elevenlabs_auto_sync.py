...
class ElevenLabsAutoSync:
    ...
    def get_all_kb_documents_cached(self, ttl_minutes: int = 60) -> List[Dict]:
        """
        ...
        if cache_file.exists():
            ...
            if age_minutes < ttl_minutes:
                print(f"  📦 Использование кэша KB (возраст: {age_minutes:.1f} мин)")
                with open(cache_file, 'r', encoding='utf-8') as f:
                    return json.load(f)

        # Получаем свежие данные
        print(f"  🔄 Загрузка свежих данных KB...")
